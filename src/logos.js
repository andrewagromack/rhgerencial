...
function LogoCardinal({
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    fill: color,
    letterSpacing: "-0.5"
  }, "RH GERENCIAL"), /*#__PURE__*/React.createElement("line", {
    x1: "0",
    y1: "62",
    x2: "468",
    y2: "62",
    ...
    letterSpacing: "2.6",
    opacity: "0.92"
  }, "ESTRATEGIA \xB7 PERSONAS \xB7 RESULTADOS"));
}
...
function LogoMonoCompact({
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    fill: color,
    letterSpacing: "-2"
  }, "RH"), /*#__PURE__*/React.createElement("rect", {
    x: "62",
    y: "34",
    width: "10",
    height: "10",
...
function LogoSeal({
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    fill: color,
    letterSpacing: "-0.5"
  }, "RH"), /*#__PURE__*/React.createElement("text", {
    x: "20",
    y: "138",
    fontFamily: "Manrope, sans-serif",
    fontSize: "36",
    ...
    fill: color,
    letterSpacing: "-0.5"
  }, "GERENCIAL"), /*#__PURE__*/React.createElement("line", {
    x1: "20",
    y1: "154",
    x2: "172",
    y2: "154",
...
function LogoMark({
  ...
  return /*#__PURE__*/React.createElement(LogoMonoCompact, {
    size: size,
    color: color,
    accent: accent
  });
